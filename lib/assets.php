...
function custom_scripts() {
	...
	wp_enqueue_style( 'custom-styles', get_stylesheet_directory_uri() .'/assets/dist/css/main.min.css', array(), filemtime(get_stylesheet_directory() . '/assets/dist/css/main.min.css'), 'all');
...
function custom_gutenberg_styles() {
	// Load the theme styles within Gutenberg.
	 wp_enqueue_style( 'custom-gutenberg', get_template_directory_uri() .  '/assets/dist/css/editor-styles.min.css' );
}
